...
5. Choose `Plugins` and install the plugins you want.
...
| Claude Code                                               | Codex CLI                                                                         | Gemini CLI                                                           |
| --------------------------------------------------------- | --------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `/plugin install anthropic-office-skills@plugins` | Open `/plugins` -> `Plugins` -> install `anthropic-office-skills` | `gemini extensions install --path ./plugins/anthropic-office-skills` |
...
| Claude Code                                            | Codex CLI                                                                      | Gemini CLI                                                        |
| ------------------------------------------------------ | ------------------------------------------------------------------------------ | ----------------------------------------------------------------- |
| `/plugin install openai-office-skills@plugins` | Open `/plugins` -> `Plugins` -> install `openai-office-skills` | `gemini extensions install --path ./plugins/openai-office-skills` |
...
| Claude Code                                     | Codex CLI                                                               | Gemini CLI                                                 |
| ----------------------------------------------- | ----------------------------------------------------------------------- | ---------------------------------------------------------- |
| `/plugin install python-skills@plugins` | Open `/plugins` -> `Plugins` -> install `python-skills` | `gemini extensions install --path ./plugins/python-skills` |
...
| Claude Code                                    | Codex CLI                                                              | Gemini CLI                                                |
| ---------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------- |
| `/plugin install react-skills@plugins` | Open `/plugins` -> `Plugins` -> install `react-skills` | `gemini extensions install --path ./plugins/react-skills` |
...
| Claude Code                                     | Codex CLI                                                               | Gemini CLI                                                 |
| ----------------------------------------------- | ----------------------------------------------------------------------- | ---------------------------------------------------------- |
| `/plugin install agent-browser@plugins` | Open `/plugins` -> `Plugins` -> install `agent-browser` | `gemini extensions install --path ./plugins/agent-browser` |
...
| Claude Code                                              | Codex CLI                                                                        | Gemini CLI                                                          |
| -------------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `/plugin install frontend-design-skills@plugins` | Open `/plugins` -> `Plugins` -> install `frontend-design-skills` | `gemini extensions install --path ./plugins/frontend-design-skills` |
...
| Claude Code                                      | Codex CLI                                                                | Gemini CLI                                                  |
| ------------------------------------------------ | ------------------------------------------------------------------------ | ----------------------------------------------------------- |
| `/plugin install mongodb-skills@plugins` | Open `/plugins` -> `Plugins` -> install `mongodb-skills` | `gemini extensions install --path ./plugins/mongodb-skills` |
...
| Claude Code                                       | Codex CLI                                                                 | Gemini CLI                                                   |
| ------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------ |
| `/plugin install supabase-skills@plugins` | Open `/plugins` -> `Plugins` -> install `supabase-skills` | `gemini extensions install --path ./plugins/supabase-skills` |
...
| Claude Code                                     | Codex CLI                                                               | Gemini CLI                                                 |
| ----------------------------------------------- | ----------------------------------------------------------------------- | ---------------------------------------------------------- |
| `/plugin install stripe-skills@plugins` | Open `/plugins` -> `Plugins` -> install `stripe-skills` | `gemini extensions install --path ./plugins/stripe-skills` |
...
| Claude Code                                    | Codex CLI                                                              | Gemini CLI                                                |
| ---------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------- |
| `/plugin install polar-skills@plugins` | Open `/plugins` -> `Plugins` -> install `polar-skills` | `gemini extensions install --path ./plugins/polar-skills` |
...
| Claude Code                                      | Codex CLI                                                                | Gemini CLI                                                  |
| ------------------------------------------------ | ------------------------------------------------------------------------ | ----------------------------------------------------------- |
| `/plugin install livekit-skills@plugins` | Open `/plugins` -> `Plugins` -> install `livekit-skills` | `gemini extensions install --path ./plugins/livekit-skills` |
...
| Claude Code                                         | Codex CLI                                                                   | Gemini CLI                                                     |
| --------------------------------------------------- | --------------------------------------------------------------------------- | -------------------------------------------------------------- |
| `/plugin install cloudflare-skills@plugins` | Open `/plugins` -> `Plugins` -> install `cloudflare-skills` | `gemini extensions install --path ./plugins/cloudflare-skills` |
...
| Claude Code                                              | Codex CLI                                                                        | Gemini CLI                                                          |
| -------------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `/plugin install web-performance-skills@plugins` | Open `/plugins` -> `Plugins` -> install `web-performance-skills` | `gemini extensions install --path ./plugins/web-performance-skills` |
...
| Claude Code                                          | Codex CLI                                                                    | Gemini CLI                                                      |
| ---------------------------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------- |
| `/plugin install openobserve-skills@plugins` | Open `/plugins` -> `Plugins` -> install `openobserve-skills` | `gemini extensions install --path ./plugins/openobserve-skills` |
...
| Claude Code                                      | Codex CLI                                                                | Gemini CLI                                                  |
| ------------------------------------------------ | ------------------------------------------------------------------------ | ----------------------------------------------------------- |
| `/plugin install hetzner-skills@plugins` | Open `/plugins` -> `Plugins` -> install `hetzner-skills` | `gemini extensions install --path ./plugins/hetzner-skills` |
...
| Claude Code                                      | Codex CLI                                                                | Gemini CLI                                                  |
| ------------------------------------------------ | ------------------------------------------------------------------------ | ----------------------------------------------------------- |
| `/plugin install dokploy-skills@plugins` | Open `/plugins` -> `Plugins` -> install `dokploy-skills` | `gemini extensions install --path ./plugins/dokploy-skills` |
...
| Claude Code                                  | Codex CLI                                                            | Gemini CLI                                              |
| -------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------- |
| `/plugin install github-dev@plugins` | Open `/plugins` -> `Plugins` -> install `github-dev` | `gemini extensions install --path ./plugins/github-dev` |
...
| Claude Code                                       | Codex CLI                                                                 | Gemini CLI                                                   |
| ------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------ |
| `/plugin install ultralytics-dev@plugins` | Open `/plugins` -> `Plugins` -> install `ultralytics-dev` | `gemini extensions install --path ./plugins/ultralytics-dev` |
...
| Claude Code                                   | Codex CLI                                                             | Gemini CLI                                               |
| --------------------------------------------- | --------------------------------------------------------------------- | -------------------------------------------------------- |
| `/plugin install azure-tools@plugins` | Open `/plugins` -> `Plugins` -> install `azure-tools` | `gemini extensions install --path ./plugins/azure-tools` |
...
| Claude Code                                    | Codex CLI                                                              | Gemini CLI                                                |
| ---------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------- |
| `/plugin install claude-tools@plugins` | Open `/plugins` -> `Plugins` -> install `claude-tools` | `gemini extensions install --path ./plugins/claude-tools` |
...
| Claude Code                                    | Codex CLI                                                              | Gemini CLI                                                |
| ---------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------- |
| `/plugin install gcloud-tools@plugins` | Open `/plugins` -> `Plugins` -> install `gcloud-tools` | `gemini extensions install --path ./plugins/gcloud-tools` |
...
| Claude Code                                          | Codex CLI                                                                    | Gemini CLI                                                      |
| ---------------------------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------- |
| `/plugin install paper-search-tools@plugins` | Open `/plugins` -> `Plugins` -> install `paper-search-tools` | `gemini extensions install --path ./plugins/paper-search-tools` |
...
| Claude Code                                    | Codex CLI                                                              | Gemini CLI                                                |
| ---------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------- |
| `/plugin install tavily-tools@plugins` | Open `/plugins` -> `Plugins` -> install `tavily-tools` | `gemini extensions install --path ./plugins/tavily-tools` |
...
| Claude Code                                       | Codex CLI                                                                 | Gemini CLI                                                   |
| ------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------ |
| `/plugin install overleaf-skills@plugins` | Open `/plugins` -> `Plugins` -> install `overleaf-skills` | `gemini extensions install --path ./plugins/overleaf-skills` |
