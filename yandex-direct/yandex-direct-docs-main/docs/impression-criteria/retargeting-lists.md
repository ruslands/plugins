---
source: https://yandex.ru/support/direct/ru/impression-criteria/retargeting-lists
---
...
- **Отказы** — пользователи, которые открыли одну страницу сайта, провели на ней меньше 15 секунд и не совершили ни одного целевого действия. По умолчанию в этот сегмент попадают визиты за последние 540 дней. Если требуется ограничить период, можно указать период при [настройке условий](../impression-criteria/retargeting-lists.md#how-to) формирования сегмента аудитории.
...
В Яндекс Метрике задайте [цели](https://yandex.ru/support/metrica/reports/add-goals.html) или [сегменты](https://yandex.ru/support/metrica/general/segmentation-report.html):
...
[Настроить сегменты аудитории](https://direct.yandex.ru/registered/main.pl?cmd=showRetargetingCond)
...
Подробнее о [корректировках ставок](../impressions/bids-adjustment.md).
