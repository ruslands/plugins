...
11. В баннере медийной кампании не должны использоваться инструменты сбора статистики (пиксели, счетчики и прочие).
    ...
    При создании кампании вы сможете указать пиксель Яндекс Аудиторий или счетчик ADFOX (подробнее в разделе [Как запустить кампанию](../fixed-cpm-campaigns/products-frontpage/create.md)), а также использовать [UTM-метки](../statistics/url-tags.md) в ссылке на сайт.
