...
- [Какие показатели отслеживать](../../fixed-cpm-campaigns/mini-banner/statistics.md#parameters)
- [Как сформировать отчет](../../fixed-cpm-campaigns/mini-banner/statistics.md#report-wizard)
- [Как принимать решения на основе статистики](../../fixed-cpm-campaigns/mini-banner/statistics.md#conclusion)
