...
В блоке **Как размещаются и покупают в вашей индустрии** для пользователей, чью категорию товаров или услуг удалось определить, доступен подробный отчет в формате PDF. Скачать его можно также на странице [Мастер отчетов](../statistics/report-wizard.md) и в уведомлениях **Что нового в Директе**.
