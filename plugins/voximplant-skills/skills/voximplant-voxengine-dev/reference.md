...
If the user does not have the Management API skill, ask them to add or install the companion skill in their current environment before continuing with platform-level debugging.
